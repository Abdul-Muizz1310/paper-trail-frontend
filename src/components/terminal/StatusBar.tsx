...
/**
 * Terminal-style strip at the bottom of the page. Flows with the
 * document (pushed to the bottom of the flex column via mt-auto)
 * so it sits beneath all content on long pages and at the viewport
 * bottom on short ones.
 */
